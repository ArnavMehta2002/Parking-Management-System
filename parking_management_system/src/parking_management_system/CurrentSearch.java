 ...
 * @author arnav mehta
 */
public class CurrentSearch extends JPanel{
    private JTable tb ;
    ...
    private void create(){
        ...
        JLabel see = new JLabel("Show all parked cars: "); 
        this.add(see);
    ...
    private void Scar(){
        ...
        if(cb.length()==0){
            ...
            try{
                PreparedStatement q = db.con.prepareStatement("select * from current_slots where car_number = ?");
                q.setString(1, cb);
    ...
    private void currAll(){
            try{
                ...
                ResultSet r = st.executeQuery("select * from current_slots");
                ...
                JLabel cl = new JLabel("All currently parked cars");
                this.add(cl);
